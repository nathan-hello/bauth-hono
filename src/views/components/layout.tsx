...
export function Layout({ meta, children, copy }: { meta: RouteMetadata; children: Child; copy: Copy }) {
    return (
        <html lang="en" style={{ backgroundColor: "#C297A0" }}>
            ...
            <body class="font-sans bg-[url('/images/carpark.webp')] bg-center bg-cover bg-fixed min-h-screen p-4 flex items-center justify-center flex-col text-fg text-xl">
                <a href="/">
